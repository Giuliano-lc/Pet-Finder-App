...
import 'package:petfinder/repository/shared_preferences_repository.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  void initState() {
    super.initState();
    bloc.mapController.listenerMapSingleTapping
        .addListener(singleTappingHandler);
  }
  ...
  void _logout() async {
    ...
    await SharedPreferencesRepository.eraseUserToken();
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    validator: (value) =>
                        value == null ? 'Selecione o porte' : null,
                  ),
                  SizedBox(
                    height: height,
                  ),
                  TextFormField(
                    decoration:
                        const InputDecoration(labelText: 'Descrição adicional'),
        ...
        Expanded(
          child: OSMFlutter(
            onGeoPointClicked: (point) =>
                bloc.onGeoPointClicked(context, point),
